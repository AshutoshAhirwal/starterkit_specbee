...
class BlockFieldWidget extends WidgetBase implements ContainerFactoryPluginInterface {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    $plugin_id_value = NestedArray::getValue($user_input, array_merge($parents, ['plugin_id']));
    $item->plugin_id = !empty($plugin_id_value) ? $plugin_id_value : $item->plugin_id;
    $settings_value = NestedArray::getValue($user_input, array_merge($parents, ['settings']));
    $item->settings = (!empty($settings_value) ? $settings_value : $item->settings) ?: [];
